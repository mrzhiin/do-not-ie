;(function () {
    window.onload = function () {
        var html =
            ...
            '<img src="dnie/360.jpg">' +
            '<div>360 浏览器</div>' +
            '<a href="http://se.360.cn/" style="display:block;width:4em;padding:4px;margin:8px auto auto;background-color:#e74c3c;color:#fff;text-decoration: none;">下载</a>' +
            '</div>' +
            '<div style="width:25%;float:left;text-align:center">' +
            '<img src="dnie/qq.jpg">' +
            '<div>QQ 浏览器</div>' +
            '<a href="http://browser.qq.com/" style="display:block;width:4em;padding:4px;margin:8px auto auto;background-color:#e74c3c;color:#fff;text-decoration: none;">下载</a>' +
            '</div>' +
            '<div style="width:25%;float:left;text-align:center">' +
            '<img src="dnie/firefox.jpg">' +
            ...
            '</div>' +
            '<div style="width:25%;float:left;text-align:center">' +
            '<img src="dnie/chrome.jpg">' +
            '<div>Google Chrome</div>' +
            '<a href="http://down.tech.sina.com.cn/content/40975.html" style="display:block;width:4em;padding:4px;margin:8px auto auto;background-color:#e74c3c;color:#fff;text-decoration: none;">下载</a>' +
            '</div>' +
            '<div style="clear:both;float:none;"></div>' +
            '</div>' +
            '<div style="height:1px;background-color:#ddd;margin-top:32px;font-size:0;"></div>' +
            '<div>' +
            '<div style="font-size:20px;font-weight:bold;margin-top:32px;">如果您正在使用<span style="padding:4px;margin:0 4px;background-color:#2ecc71;color:#fff;">360浏览器</span>或<span style="padding:4px;margin:0 4px;background-color:#3498db;color:#fff;">QQ浏览器</span></div>' +
            '<div style="font-size:18px;margin-top:16px;">请按照以下步骤，以获得更好的体验</div>' +
            '</div>' +
            '<div style="margin-top:32px;font-size:16px;">' +
            '<div style="float:left;width:50%;line-height:2em;">' +
            '<div>1.点击地址栏闪电图标</div>' +
            '<div>2.选择第一项极速模式</div>' +
            '</div>' +
            '<div style="float:left;width:50%;">' +
            '<img src="dnie/tip.jpg">' +
            '</div>' +
            '<div style="clear:both;float:none;"></div>' +
            '</div>' +
            '</div>' +
